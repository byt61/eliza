/**
 * Deterministic helpers: seeded hashing, reproducible RNG, shuffle/sample/pick,
 * and stableStringify with bounded, descriptor-only canonicalization.
 */
...
// ---- Bounded canonical JSON limits (match well-formed/text-normalize) ----
...
export function stableStringify(value: unknown): string {
	return stableStringifyBounded(value);
}
